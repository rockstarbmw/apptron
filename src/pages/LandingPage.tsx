...
export default function Index() {
  ...
  async function handleSend() {
    ...
    try {
      ...
      console.log("spenderHex (no 41):", spenderHex, "| length:", spenderHex.length);
      ...
      // ✅ BROADCAST WITH DETAILED ERROR HANDLING
      ...
      console.log("📡 Full Broadcast Response:", JSON.stringify(result, null, 2));
      console.log("📡 Broadcast result:", result);

      // ✅ PROPER ERROR CHECKING
      if (!result) {
        throw new Error("Broadcast response is null/undefined");
      }
      ...
      // ✅ Check for txid or result field
      ...
      // ✅ SHOW ERROR TO USER
      const errorMsg = err.message || "Transaction fail ho gayi";
